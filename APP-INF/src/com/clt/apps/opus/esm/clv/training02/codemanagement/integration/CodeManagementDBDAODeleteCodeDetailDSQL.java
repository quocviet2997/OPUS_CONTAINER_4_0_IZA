...
*@FileName : CodeManagementDBDAODeleteCodeDetailDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeManagementDBDAODeleteCodeDetailDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeManagementDBDAODeleteCodeDetailDSQL(){
		setQuery();
		...
		query.append("FileName : CodeManagementDBDAODeleteCodeDetailDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
