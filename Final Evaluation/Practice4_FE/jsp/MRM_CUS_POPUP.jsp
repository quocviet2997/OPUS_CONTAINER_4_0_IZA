		...
		<div class="opus_design_inquiry">
		    <table>
		        ...
		        <tbody>
					<tr>
					   	<th>Country</th><!--
						--><td><input type="text" style="width:100px;" class="input" value="" name="s_cust_cnt_cd" id="s_cust_cnt_cd"></td><!--
						--><th>Sequence</th><!--
						--><td><input type="text" style="width:100px;" class="input" value="" name="s_cust_seq" id="s_cust_seq"></td>
					</tr> 
				</tbody>
			</table>
		</div>
