...
*@FileName : CodeManagementDBDAOCodeMgmtDtlVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeManagementDBDAOSearchCodeDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * query in COM_INTG_CD_DTL table
	  * </pre>
	  */
	public CodeManagementDBDAOSearchCodeDetailRSQL(){
		setQuery();
		...
		query.append("FileName : CodeManagementDBDAOCodeMgmtDtlVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
