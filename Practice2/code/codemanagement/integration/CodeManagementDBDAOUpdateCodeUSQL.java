...
*@FileName : CodeManagementDBDAOCodeMgmtVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeManagementDBDAOUpdateCodeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeManagementDBDAOUpdateCodeUSQL(){
		setQuery();
		...
		query.append("FileName : CodeManagementDBDAOCodeMgmtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
