...
*@FileName : CodeManagementDBDAOUpdateCodeDetailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeManagementDBDAOUpdateCodeDetailUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeManagementDBDAOUpdateCodeDetailUSQL(){
		setQuery();
		...
		query.append("FileName : CodeManagementDBDAOUpdateCodeDetailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
