...
*@FileName : CodeManagementDBDAOCodeMgmtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeManagementDBDAODeleteCodeDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeManagementDBDAODeleteCodeDSQL(){
		setQuery();
		...
		query.append("FileName : CodeManagementDBDAOCodeMgmtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
